  ...
  template: `
    <div class="edit-book-container">
      ...
      <div *ngIf="!found" class="not-found">
        <p>Book not found.</p>
        <button class="btn btn-primary" (click)="onCancel()">Back to Library</button>
      </div>
      ...
      <form *ngIf="found" [formGroup]="bookForm" (ngSubmit)="onSubmit()">
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <div class="error" *ngIf="bookForm.get('title')?.touched && bookForm.get('title')?.invalid">Title is required</div>
          </div>
          <div class="form-group">
            ...
            <div class="error" *ngIf="bookForm.get('author')?.touched && bookForm.get('author')?.invalid">Author is required</div>
          </div>
        </div>
        ...
        <div class="form-row">
          ...
          <div class="form-group">
            ...
            <div class="error" *ngIf="bookForm.get('lentDate')?.touched && bookForm.get('lentDate')?.invalid">Date is required for lent books</div>
          </div>
        </div>
        ...
        <div class="form-group" *ngIf="isLentOut">
          ...
          <div class="error" *ngIf="bookForm.get('borrowedBy')?.touched && bookForm.get('borrowedBy')?.invalid">Please enter the borrower's name</div>
        </div>
        ...
        <div class="actions">
          ...
          <button type="submit" class="btn btn-primary" [disabled]="bookForm.invalid">Save Changes</button>
        </div>
      </form>
    </div>
  `,
